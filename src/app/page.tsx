      ...
      <main className="relative pb-24 pl-4 lg:pl-16">
        <div className="flex flex-col space-y-2 py-16 md:space-y-4 lg:h-[65vh] lg:justify-end lg:pb-12">
          <div className="absolute left-0 top-0 -z-10 flex h-[95vh] w-screen flex-col bg-black ">
            <Image
              src="/banners/TheWitcher/banner_07.jpg"
              alt="MAID"
              fill={true}
          ...
          <p className="text-shadow-md shadow-md max-w-xs text-xs md:max-w-lg md:text-lg lg:max-w-2xl">
        ...
        <div className="flex space-x-3">
          ...
          <button className="md:text-xl; flex cursor-pointer items-center gap-x-2 rounded bg-gray-700 px-5 py-1.5 text-sm font-semibold text-white transition hover:opacity-75 md:px-8 md:py-2.5">
            More Info
          </button>
        </div>
      </main>
